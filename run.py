...
Root-level convenience wrapper for running the backend server

This allows you to run 'python run.py' from the project root
without having to navigate to the backend1 directory.
...
# Import and run the actual application from backend1
